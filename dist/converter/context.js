...
export function createMCF({ outputDir, functionCallPrefix }, errorOnSpyglass = false) {
    ...
    async function finalize() {
        ...
        if (!spyglass || !javaEdition || !getNodeJsExternals) {
            ...
            const cacheRoot = pathToFileURL(`${tempOutputDir}.spyglass-cache/`).href;
            const projectRoot = pathToFileURL(`${tempOutputDir}/`).href;
